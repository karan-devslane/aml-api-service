...
('9b50a7e7-fdec-4fd7-bf63-84b3e62e4231', 
 '{"en": "1D/2D by 1D without remainder (Quotient <=10) (whole Dividend lies in the table of Divisor)", "hi": "1D/2D द्वारा 1D बिना शेष के (कोटिएंट <=10) (लंबी विभाजन)"}',
...
('9b50a7e7-fdec-4fd7-bf63-84b3e62e4232', 
 '{"en": "2D by 1D without remainder (Where divsion will be done digit by digit , with only non-zero digits in Dividend)", "hi": "2D द्वारा 1D बिना शेष के (जहाँ विभाजन अंकों द्वारा किया जाएगा)"}',
...
('9b50a7e7-fdec-4fd7-bf63-84b3e62e4233', 
 '{"en": "2D by 1D without remainder (Where division will be done digit by digit, with 0 OR non-zero digits in Dividend)", "hi": "2D द्वारा 1D बिना शेष के (जहाँ विभाजन अंकों द्वारा किया जाएगा, जिसमें 0 शामिल है)"}',
...
('9b50a7e7-fdec-4fd7-bf63-84b3e62e4234', 
 '{"en": "2D by 1D without remainder (Where remainder will be there after 1st subtraction, with 0 or non-zero digits in Dividend)", "hi": "2D द्वारा 1D बिना शेष के (जहाँ पहले घटाव के बाद शेष होगा)"}',
...
('9b50a7e7-fdec-4fd7-bf63-84b3e62e4236', 
 '{"en": "3D by 1D without remainder (Where the division will happen digit by digit with and without 0 in Dividend)", "hi": "3D द्वारा 1D बिना शेष के (जहाँ विभाजन अंकों द्वारा होगा, जिसमें और बिना 0 शामिल है)"}',
...
create table if not exists learner_proficiency_aggregate_data (
  ...
  l1_skill_id varchar(255),
  l2_skill_id varchar(255),
  l3_skill_id varchar(255),
  sub_skills jsonb,
